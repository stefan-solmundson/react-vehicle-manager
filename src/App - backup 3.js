...
class App extends Component {
    ...
    //         /*
    //         Nothing created by NORMAL javcascript can use "react" javascript,
    //         react isn't on the same level as normal javascript,
    //         react is a layer above and is compiled down to normal javascript
    //         */
    //         // td.innerHTML = "woot";
    //         // td.innerHTML = <button onClick="thingo2">EditAdd</button>
    //         // td.innerHTML = '<button onClick="this.thingo2(0, 0, 0)">EditAdd</button>';
    //         // td.innerHTML = '<button onClick="{this.thingo2(0, 0, 0)}">EditAdd</button>';
    //         // td.innerHTML = '<button onClick="{thingo2(0, 0, 0)}">EditAdd</button>';
    //         // td.innerHTML = '<button onClick="e => {console.log(\'hello\'); e.state.testVar = true;">EditAdd</button>';
    //         // td.innerHTML = '<button onClick=`console.log(\'hello\') ${this.thingo2(0, 0, 0)};`>EditAdd</button>';
    //         // td.innerHTML = '<button onClick=`${this.thingo2(0,0,0)}`>EditAdd</button>';
    //         td.innerHTML = '<button onClick="console.log(\'hello\'); this.setState({testVar: true});">EditAdd</button>';
    //         // {thingo2(${rowId})}
    //         // `<Link
    //         //     to= {{
    ...
    render() {
        ...
        return (
            <div>
                ...
                {/*<MDBBtn onClick="{this.thingo; this.setState({testVar: true}); console.log(this.state.testVar)}">*/}
                {/*<MDBBtn onClick="this.thingo; this.setState({testVar: true}); console.log(this.state.testVar)">*/}
